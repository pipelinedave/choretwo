<template>
  ...
  >
    ...
    <div v-show="swipeDirection" class="swipe-actions-overlay">
      <div
      ...
      <div
        ...
        :class="{ active: swipeDirection === 'down' }"
...
function handleMouseUp() {
  ...
  const totalDelta = Math.sqrt(
    currentX.value * currentX.value + currentY.value * currentY.value,
  );
