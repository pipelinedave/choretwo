  ...
  <div class="ai-view">
    <div class="ai-header">
      <div class="ai-header-content">
        <span
          class="mdi mdi-robot-happy"
          style="font-size: 48px; color: var(--md-sys-color-primary)"
        ></span>
        <h1>AI Copilot</h1>
...
const quickActions = [
  {
    label: "What chores do I have?",
    command: "What chores do I have?",
    icon: "mdi-list-box-outline",
  },
  {
    label: "Add a new chore",
    command: "Add a new chore",
    icon: "mdi-plus-circle",
  },
  {
    label: 'Mark "wash dishes" done',
    command: "Mark wash dishes as done",
    icon: "mdi-check-circle",
  },
  {
    label: "Give me suggestions",
    command: "Give me suggestions",
    icon: "mdi-lightbulb",
  },
  {
    label: "Analyze my patterns",
    command: "Analyze my chore patterns",
    icon: "mdi-chart-line",
  },
  {
    label: "Show stats",
    command: "Show me my chore statistics",
    icon: "mdi-chart-bar",
  },
];
