...
from notify.app.celery_app import celery_app
from notify.app.services.notifier import (
    send_chore_overdue_notification,
    send_chore_due_soon_notification,
)
from notify.app.services.scheduler import (
...
def send_scheduled_notifications():
    ...
    from notify.app.database import SessionLocal
...
def check_overdue_chores():
    ...
    from notify.app.database import SessionLocal
    from notify.app.services.scheduler import create_scheduled_notification
...
def send_notification_task(user_email: str, message: str, title: str, priority: int):
    ...
    from notify.app.services.notifier import send_gotify_notification
